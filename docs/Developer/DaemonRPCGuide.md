...
-   _block_header_  - A structure containing block header information.
    ...
    -   _major_version_  - unsigned int; The major version of the beldex protocol at this block height.
    -   _minor_version_  - unsigned int; The minor version of the beldex protocol at this block height.
...
-   _bootstrap_daemon_address_  - string; 
