...
This way services like [Shapeshift](https://shapeshift.io) wouldn't know it is you again receving Beldex.
...
!!! Note
    Feel free to skip this if your are new to Beldex. Accounts are not essential and currently not supported by the GUI.
...
------------|------------------|-------------------------------------------------------------
0           | 1                | identifies the network and address type; [116](https://github.com/beldex-coin/beldex/blob/master/src/cryptonote_config.h#L183) - mainnet; [36](https://github.com/beldex-coin/beldex/blob/master/src/cryptonote_config.h#L226) - stagenet; [158](https://github.com/beldex-coin/beldex/blob/master/src/cryptonote_config.h#L203) - testnet
